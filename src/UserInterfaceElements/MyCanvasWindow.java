...
/**
 * Class of canvaswindow with methods for handling mouse events and key events
 */
public class MyCanvasWindow extends CanvasWindow {
    ...
    /**
     * Constructor that creates a blank canvas and title and initiates the controller with an extra parameter i (used for testing)
     *
     * @param title title of the canvas
     * @param i     parameter used for testing
     */
